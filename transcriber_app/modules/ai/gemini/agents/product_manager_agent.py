# transcriber_app/modules/ai/agents/product_manager_agent.py
...
product_manager_agent = GeminiAgent(
    model_name=USE_MODEL,
    system_prompt=load_prompt(AVAILABLE_MODES_DICT["product_manager"])
)
